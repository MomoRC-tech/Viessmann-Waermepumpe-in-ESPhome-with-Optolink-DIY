...
void setupHomeAssistant() {   
    ...
    WWtempSollSens.setMin(20);  WWtempSollSens.setMax(60);   WWtempSollSens.setStep(1);                             WWtempSollSens.onCommand(setWWSoll);            WWtempSollSens.setMode(HANumber::Mode::ModeBox);  
    ...
    WWtempSoll2Sens.setMin(20);  WWtempSoll2Sens.setMax(60);   WWtempSoll2Sens.setStep(1);                             WWtempSoll2Sens.onCommand(setWWSoll2);       WWtempSoll2Sens.setMode(HANumber::Mode::ModeBox);
    ...
    HKneigungSens.setMode(HANumber::Mode::ModeBox);
    ...
    HKniveauSens.setMode(HANumber::Mode::ModeBox);
    ...
    HystWWsollSens.setMode(HANumber::Mode::ModeBox);
    ...
    RaumSollTempSens.setMode(HANumber::Mode::ModeBox);
    ...
    RaumSollRedSens.setMode(HANumber::Mode::ModeBox);
    ...
    fastPollInterval.setMode(HANumber::Mode::ModeBox);  
    ...
    mediumPollInterval.setMode(HANumber::Mode::ModeBox); 
    ...
    slowPollInterval.setMode(HANumber::Mode::ModeBox); 
    ...
    errorThresholdNumber.setMode(HANumber::Mode::ModeBox);  
